...
export default function DashboardSidebar() {
  ...
  return (
    <div>
      ...
      <div
        id="dashboardSidebar"
        className={`fixed inset-y-0 left-0 z-10 w-64 transform bg-white shadow-lg transition-transform duration-300 ease-in-out xl:relative xl:transform-none xl:shadow-none ${
          isSidebarVisible
            ? "translate-x-0"
